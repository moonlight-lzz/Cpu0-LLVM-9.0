...
static MCStreamer *createMCStreamer(const Triple &T, MCContext &Context,
                                    ...
                                    bool RelaxAll) {
  MCStreamer *S;
  S = createCpu0ELFStreamer(Context, std::move(MAB), std::move(OW),
...
extern "C" void LLVMInitializeCpu0TargetMC() {
  ...
  TargetRegistry::RegisterMCAsmBackend(getTheCpu0Target(),
                                       createCpu0AsmBackendEB32);
  TargetRegistry::RegisterMCAsmBackend(getTheCpu0elTarget(),
